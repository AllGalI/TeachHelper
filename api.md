...
### 6.2 Получить все задания
**GET** `/tasks`

**Требует аутентификации:** Да (только для учителя)

**Query параметры (фильтры):**
- `name`: string (опционально, поиск по названию)

**Ответ:** `200 OK` (массив заданий)

---

### 6.3 Получить задание по ID
**GET** `/tasks/{id}`
...
```json
{
  "students_ids": ["uuid1", "uuid2"],
  "classrooms_ids": ["uuid1", "uuid2"]
}
```
